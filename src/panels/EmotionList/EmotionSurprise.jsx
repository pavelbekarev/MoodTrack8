            ...
            <Div className="list_wrapper">
                <Div className="cellbuttons_row">
                    <CellButton
                        ...
                        onClick={() => {
                            dispatch(addEmotion("Потрясение "));
                ...
                <Div className="cellbuttons_row">
                    <CellButton 
                        ...
                        onClick={() => {
                            dispatch(addEmotion("Возбуждение "));
                    ...
                    <CellButton 
                        ...
                        onClick={() => {
                            dispatch(addEmotion("Озабоченность "));
